...
import {
  ErrorStateMatcher,
  _ErrorStateTracker
} from "./chunk-ADXUQV6T.js";
import {
  FormGroupDirective,
  NgControl,
  NgForm,
  Validators
} from "./chunk-ACSIBHLW.js";
import {
  CdkScrollableModule,
  ScrollDispatcher,
  ScrollingModule,
  SelectionModel,
  ViewportRuler
} from "./chunk-MWISTIU2.js";
import {
  MAT_FORM_FIELD,
  MatFormField,
  MatFormFieldControl,
  MatFormFieldModule
} from "./chunk-EUGCK3C4.js";
import {
  MatButtonModule,
  MatIconButton,
  MatRipple,
...
} from "./chunk-GKCGHJFS.js";
import {
  _isTestEnvironment
} from "./chunk-B7UWRV67.js";
import {
...
} from "./chunk-VGGRLCJE.js";
import {
  BidiModule,
  Directionality
} from "./chunk-WA3WV3VL.js";
import {
  Platform,
  _CdkPrivateStyleLoader,
  _bindEventWithOptions,
  coerceNumberProperty
} from "./chunk-NTEXRX7F.js";
import {
  Location,
  NgClass
...
var MatTooltip = class _MatTooltip {
  ...
  ngAfterViewInit() {
    ...
    this._setupPointerEnterEventsIfNeeded();
    this._focusMonitor.monitor(this._elementRef).pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe((origin) => {
      if (!origin) {
  ...
  show(delay = this.showDelay, origin) {
    ...
    instance.afterHidden().pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._setTooltipClass(this._tooltipClass);
    this._updateTooltipMessage();
    instance.show(delay);
  }
  ...
  _createOverlay(origin) {
    ...
    strategy.positionChanges.pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe((change) => {
    ...
    this._updatePosition(this._overlayRef);
    this._overlayRef.detachments().pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._overlayRef.outsidePointerEvents().pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => this._tooltipInstance?._handleBodyInteraction());
    this._overlayRef.keydownEvents().pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe((event) => {
    ...
    if (!this._dirSubscribed) {
      ...
      this._dir.change.pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => {
        if (this._overlayRef) {
          this._updatePosition(this._overlayRef);
        }
      });
...
var TooltipComponent = class _TooltipComponent {
  ...
  _onHide = new import_rxjs5.Subject();
...
var MatPaginator = class _MatPaginator {
  ...
  _intlChanges;
  _isInitialized = false;
  _initializedStream = new import_rxjs6.ReplaySubject(1);
  /**
